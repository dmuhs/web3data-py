...
The sources for web3data-py can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/dmuhs/web3data-py
.. _tarball: https://github.com/dmuhs/web3data-py/tarball/master
